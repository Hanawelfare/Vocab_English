...
document.addEventListener("DOMContentLoaded", () => {
  ...
  async function generateAISentences() {
    ...
    const batchSize = 10; // Batch 10 words in a single prompt to stay within rate limits!
    ...
    for (let i = 0; i < pendingWords.length; i += batchSize) {
      ...
      // 5 seconds cooldown to strictly respect the 15 RPM free limit (max 12 requests per minute)
